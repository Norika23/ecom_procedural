...
<a href="index.php?edit_product&id={$row['product_id']}"><img style="height:90px; width:150px " src="../../resources/{$product_image}"  alt=""></a>
</td>
<td>{$category}</td>
...
function add_product() {
    ...
    if(isset($_POST['publish'])) {
        ...
        product_description, short_desc, product_quantity, product_image, image_temp_location) 
        VALUES('{$product_title}', '{$product_category_id}', '{$product_price}', '{$product_description}',
        '{$short_desc}', '{$product_quantity}', '{$product_image}', '{$image_temp_location}')  ");
        
        $last_id = last_id();
        confirm($query);
        set_message("New Product id {$last_id} Just Added");
...
function get_current_slide_in_admin() {
    ...
    while($row = fetch_array($query)) {
        ...
        <img style="height:90px" class="img-responsive" src="../../resources/{$slide_image}" alt="">
...
<img style="height:290px" class="slide-image" src="../resources/{$slide_image}" alt="">
</div>
DELIMETER;
...
<img style="height:90px" class="img-responsive slide_image" src="../../resources/{$slide_image}" alt="">
</a>
<div class="caption">
<p>{$row['slide_title']}</p>
</div>
